...
Это понедельник 05:17 UTC. Для ежедневного режима можно заменить на:
...
Не ставь слишком частый запуск: для prompt research обычно достаточно 1 раз в день или 1 раз в неделю.
